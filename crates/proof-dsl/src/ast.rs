...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub enum Jurisdiction { UK, EU, US }

#[derive(Debug, Clone, Serialize, Deserialize)]
pub enum Regulator { FCA, PRA, CFPB, EBA }

#[derive(Debug, Clone, Serialize, Deserialize)]
pub enum ProductCategory { Deposit, Credit, Mortgage, Investment }
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub enum AccrualFrequency  { Daily, Monthly, Quarterly, Annually }
#[derive(Debug, Clone, Serialize, Deserialize)]
pub enum DayCountBasis     { Act365, Act360, Thirty360 }
#[derive(Debug, Clone, Serialize, Deserialize)]
pub enum CompoundFrequency { Daily, Monthly, Quarterly, Annually }

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct FeesBlock { pub fees: Vec<Fee> }
